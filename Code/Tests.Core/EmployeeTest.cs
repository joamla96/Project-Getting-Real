...
namespace Tests.Core {
	...
	public class EmployeeTests {
        ...
        public void TestSaveEmployeeInRepository()
        {
            ...
            Employee A = new Employee(1, "test@example.com", "1234", "Test", "User", Address_A, "12344567", 2);
		...
		public void TestLogin() {
			...
			Employee B = new Employee(2, "test2@example.com", "1235", "Test2", "User2", Address_B, "23456789", 1);
			EmployeeRepository.SaveEmployee(B);

			Employee X = EmployeeRepository.Login("test@example.com", "1234");
		...
		public void TestCanUpdateEmployee() {
			Address Address_A = new Address(38, "Grønløkkevej", 5000, "Odense");
			Employee A = new Employee(1, "test@example.com", "1234", "Test", "User", Address_A, "12344567", 1);
			EmployeeRepository.SaveEmployee(A);
